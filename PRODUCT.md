...
| 专注 | 雨夜自习室、动态雨幕、iPhone 可播放的独立雨声 / 原创轻音乐、双音量、播放失败提示、25 / 45 / 60 分钟、开始、暂停、继续、结束、刷新续时 | 真实计时器、本地音频与声音偏好 |
...
- 自习室的雨声与轻音乐是仓库内原创生成的同源 MP3，不依赖远程音频服务、外部账号或受版权限制的音乐文件；系统减少动态效果时保留静态雨景。
