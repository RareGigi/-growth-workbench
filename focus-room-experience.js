(() => {
  ...
  const VERSION = '2026.09-final-16-rooms';
  const ROOMS = Object.freeze([
    { id:'leaf-rain', proxy:'leaf-rain', name:'窗叶听雨', image:'assets/scenes/focus-leaf-rain.webp', note:'贴近窗边的雨声与纸笔感，适合做题和长时间专注。', tag:'写实 · 雨夜', groups:['real','rain'], ambience:'leaf-rain', music:'rain-brushstrokes', ambienceVolume:.46, musicVolume:.12, rain:true, eyebrow:'雨落叶尖' },
    { id:'library', proxy:'library', name:'深夜图书馆', image:'assets/scenes/focus-library.webp', note:'木质书库与稳定底噪，适合阅读、复盘和整理。', tag:'写实 · 安静', groups:['real'], ambience:'library', music:'quiet-books', ambienceVolume:.38, musicVolume:.10, rain:false, eyebrow:'深夜书页' },
    { id:'cafe', proxy:'cafe', name:'雨晨咖啡厅', image:'assets/scenes/focus-cafe.webp', note:'远处模糊人声与细雨，适合轻任务和自由写作。', tag:'写实 · 雨晨', groups:['real','rain'], ambience:'cafe', music:'breezy-terrace', ambienceVolume:.36, musicVolume:.11, rain:true, eyebrow:'雨晨一隅' },
    { id:'magic-bookshop', proxy:'magic-bookshop', name:'月灯书屋', image:'assets/scenes/focus-magic-bookshop.webp', note:'旧书、炉火与一盏不熄的灯，适合夜读和沉浸写作。', tag:'奇幻 · 暖灯', groups:['fantasy'], ambience:'hearth', music:'lamplight-chapter', ambienceVolume:.32, musicVolume:.10, rain:false, eyebrow:'月灯长明' },
    { id:'celestial', proxy:'celestial', name:'云上天宫', image:'assets/scenes/focus-celestial.webp', note:'云气和远山打开视野，适合换脑子后重新进入状态。', tag:'玄幻 · 云间', groups:['xuanhuan'], ambience:'cloud-wind', music:'constellations', ambienceVolume:.34, musicVolume:.09, rain:false, eyebrow:'云海之上' },
    { id:'temple', proxy:'temple', name:'山寺晨光', image:'assets/scenes/focus-temple.webp', note:'晨光、松风与疏钟，适合早起学习和清醒复盘。', tag:'古风 · 晨光', groups:['ancient'], ambience:'temple', music:'temple-dawn', ambienceVolume:.32, musicVolume:.09, rain:false, eyebrow:'松风疏钟' },
    { id:'forest-glasshouse', proxy:'forest-glasshouse', name:'雾林花房', image:'assets/scenes/focus-forest-glasshouse.webp', note:'玻璃外是湿润松林，适合恢复注意力。', tag:'写实 · 雾林雨', groups:['real','rain'], ambience:'glasshouse-rain', music:'glasshouse-ghosts', ambienceVolume:.40, musicVolume:.10, rain:true, eyebrow:'雾林雨声' },
    { id:'snow-cabin', proxy:'snow-cabin', name:'雪夜木屋', image:'assets/scenes/focus-snow-cabin.webp', note:'炉火守着窗外落雪，适合安静长读。', tag:'写实 · 雪夜', groups:['real'], ambience:'snow-wind', music:'snow-needle', ambienceVolume:.36, musicVolume:.10, rain:false, eyebrow:'窗外初雪' },
    { id:'ocean-cliff', proxy:'ocean-cliff', name:'海崖晨光', image:'assets/scenes/focus-ocean-cliff.webp', note:'海面拉开视野，适合清晨梳理与复盘。', tag:'写实 · 海岸', groups:['real'], ambience:'ocean-swell', music:'sea-glass', ambienceVolume:.42, musicVolume:.09, rain:false, eyebrow:'潮汐晨光' },
    { id:'night-train', proxy:'night-train', name:'夜行列车', image:'assets/scenes/focus-night-train.webp', note:'窗外灯火缓慢后退，陪你把事情往前推。', tag:'写实 · 雨夜列车', groups:['real','rain'], ambience:'train-rain', music:'last-train', ambienceVolume:.34, musicVolume:.11, rain:true, eyebrow:'夜雨远行' },
    { id:'atelier-spring', proxy:'atelier-spring', name:'春日画室', image:'assets/scenes/atelier-spring.webp', note:'留白、花枝与晨光，适合规划和创作。', tag:'写实 · 春日', groups:['real'], ambience:'window-rain', music:'graphite', ambienceVolume:.28, musicVolume:.10, rain:false, eyebrow:'春日留白' },
    { id:'lakeside-autumn', proxy:'lakeside-autumn', name:'湖畔书台', image:'assets/scenes/lakeside-autumn.webp', note:'让湖面拉开思路，适合阅读与复盘。', tag:'写实 · 秋湖', groups:['real'], ambience:'ocean-swell', music:'breezy-terrace', ambienceVolume:.30, musicVolume:.09, rain:false, eyebrow:'秋湖书页' },
    { id:'conservatory-lavender', proxy:'conservatory-lavender', name:'薰衣草花房', image:'assets/scenes/conservatory-lavender.webp', note:'玻璃雨声包住桌面，温柔推进不费力。', tag:'写实 · 花房雨', groups:['real','rain'], ambience:'glasshouse-rain', music:'constellations', ambienceVolume:.38, musicVolume:.08, rain:true, eyebrow:'花房细雨' },
    { id:'tram-rain', proxy:'tram-rain', name:'雨夜电车站', image:'assets/scenes/tram-rain.webp', note:'雨幕和远行节奏，陪你完成一轮短冲刺。', tag:'写实 · 城市雨', groups:['real','rain'], ambience:'train-rain', music:'rain-brushstrokes', ambienceVolume:.40, musicVolume:.10, rain:true, eyebrow:'雨幕车站' },
    { id:'cloud-pavilion-study', proxy:'cloud-pavilion-study', name:'云间仙阁', image:'assets/scenes/cloud-pavilion-study.webp', note:'云海把杂念放远，适合长读与安静书写。', tag:'古风玄幻 · 云海', groups:['ancient','xuanhuan'], ambience:'cloud-wind', music:'temple-dawn', ambienceVolume:.30, musicVolume:.08, rain:false, eyebrow:'云间长卷' },
    { id:'astral-archive', proxy:'astral-archive', name:'星潮秘库', image:'assets/scenes/astral-archive.webp', note:'拨动星盘之前，先把眼前这一页完成。', tag:'奇幻 · 星图', groups:['fantasy'], ambience:'library', music:'constellations', ambienceVolume:.30, musicVolume:.08, rain:false, eyebrow:'星潮秘卷' }
  ]);
  ...
  function recommendedId() {
    ...
    if (hour < 5) return 'astral-archive';
    if (hour < 8) return 'temple';
    if (hour < 11) return 'atelier-spring';
    if (hour < 14) return 'cafe';
    if (hour < 17) return 'library';
    if (hour < 20) return 'cloud-pavilion-study';
  ...
  function preset(item, enable = false) {
    const settings = state().focusSettings;
    if (!settings) return;
    const preset = Core.FOCUS_SOUND_PRESETS[item.id] || Core.FOCUS_SOUND_PRESETS['leaf-rain'];
    settings.ambienceId = preset.ambienceId;
    settings.musicId = preset.musicId;
  ...
  function chooseRoom(id) {
    ...
    preset(item, false);
    Core.save('focus-room-experience');
    requestAnimationFrame(() => {
  ...
  function applyRecommended() {
    ...
    const wasPlaying = Boolean(document.querySelector('.timer-panel .sound-master.active'));
    preset(item, true);
    Core.save('focus-room-experience-recommended');
