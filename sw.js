const CACHE='star-growth-cabin-v23';
const ASSETS=['./','./index.html','./style-v2.css?v=7','./nav-v4.css?v=7','./house-v3.css?v=7','./game-v4.css?v=7','./game-v5.css?v=7','./game-shell-v5.css?v=23','./app-v2.js?v=7','./house-v3.js?v=7','./wardrobe-engine-v5.js?v=7','./game-v4.js?v=7','./game-shell-v5.js?v=23','./manifest.webmanifest','./icon.svg','./assets/dressup-2d/base-approved.webp','./assets/avatar-v5/mist-city-walk-preview.png'];
