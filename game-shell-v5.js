/* 星回衣橱 v38：固定人体锚点母图 + 同坐标可穿脱单品。 */
(function () {
  const VERSION = '38';
  const IMAGE = {
    base: 'assets/dressup-v38/base.webp',
    composite: 'assets/dressup-v38/composite.webp',
    top: 'assets/dressup-v38/top.webp',
    bottom: 'assets/dressup-v38/bottom.webp',
    outer: 'assets/dressup-v38/outer.webp',
    shoes: 'assets/dressup-v38/shoes.webp',
    thumbTop: 'assets/dressup-v38/thumb-top.webp',
    thumbBottom: 'assets/dressup-v38/thumb-bottom.webp',
    thumbOuter: 'assets/dressup-v38/thumb-outer.webp',
    thumbShoes: 'assets/dressup-v38/thumb-shoes.webp'
  };
  ...
  const saved = data.game2d.mistV38?.equipped
    || data.game2d.mistV37?.equipped
    ...
    || FULL;
  data.game2d.mistV38 = { equipped: { ...FULL, ...saved } };
  const state = data.game2d.mistV38;
  ...
  app.id = 'gameAppV5';
  app.className = 'gameAppV5 dressupApp dressupV32 dressupV33 dressupV34 dressupV35 dressupV36 dressupV37 dressupV38';
  ...
  function enterGame2d() {
    document.body.classList.add('game-mode', 'dressup-v21-active', 'dressup-v23-active', 'dressup-v32-active', 'dressup-v33-active', 'dressup-v34-active', 'dressup-v35-active', 'dressup-v36-active', 'dressup-v37-active', 'dressup-v38-active');
  ...
  function exitGame2d() {
    ...
    document.body.classList.remove('game-mode', 'dressup-v21-active', 'dressup-v23-active', 'dressup-v31-active', 'dressup-v32-active', 'dressup-v33-active', 'dressup-v34-active', 'dressup-v35-active', 'dressup-v36-active', 'dressup-v37-active', 'dressup-v38-active');
